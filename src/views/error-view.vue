<template>
  <div class="grid min-h-full place-items-center px-6 py-24 sm:py-32 lg:px-8">
    <div class="text-center">
      <p class="font-semibold text-error">404</p>
      ...
      <div class="mt-10 flex items-center justify-center gap-x-6">
        <router-link :to="{ name: 'Home' }" class="btn btn-error"> Go back </router-link>
        <router-link :to="{ name: 'Help' }" class="btn btn-ghost">More information<span
